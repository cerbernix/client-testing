...
The `tokenFile` option points to a file containing your `cbx_...` bearer token. It is read at service start into the `CERBERNIX_TOKEN` environment variable — never passed as a CLI argument or stored in the nix store. This is compatible with [arcanum](https://github.com/bitnixdev/arcanum), [sops-nix](https://github.com/Mic92/sops-nix), [agenix](https://github.com/ryantm/agenix), or manual file placement.
